...
export const sendOTPEmail = async (userEmail, otp) => {
  ...
  const payload = {
    // IMPORTANT: Make sure this email matches your verified Brevo account email
  ...
  try {
    const response = await fetch(url, {
      ...
      headers: {
        ...
        'api-key': process.env.BREVO_API_KEY, // This MUST be the REST API key (starts with xkeysib-)
